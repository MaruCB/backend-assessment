...
def test_main(mock_open: MagicMock, mock_os: MagicMock, mock_data_importer_json: MagicMock) -> None:
    # Execute main
    test_user_data = [
        {"forename": "Maria", "surname": "Casado", "date_of_birth": "1988/02/13", "location": "London", "company_id": 1}
    ]

    test_companies_data = [{"id": 1, "name": "Head Journal", "headquarters": "San Francisco", "industry": "Tech"}]
